...
<div class="panel panel-default">
    ...
    <?php $import = false; $alt = false; $panelsup = ['Corporaciones','Corporaciones','corporaciones','Corporación']; ?>
...
<div class="modal fade" id="ModalCrear" role="dialog">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      {!!Form::open(['action' => array('CorporacionesController@store', $sec), 'method' => 'POST'])!!}
